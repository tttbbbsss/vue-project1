  ...
  <div>
    ...
    >
        ...
        >
            ...
            <!--  级联选择器-->
            <!--  expandTrigger: 'hover' 表示通过鼠标覆盖来展开菜单 -->
            <!-- :options="options"表示当前级联选择器的数据元的 -->
            <!--  :props表示指定选择器的配置对象 -->
            <!-- @change="handleChange"只要级联选择器的选中项发生变化，就会触发这个函数 -->
...
export default {
    ...
    methods:{
        ...
        parentCateChanged(){
            ...
            // 如果selectedKeys数组中的length大于0，证明选中了父级分类，反之，没有选中任何分类
            if(this.selectedKeys.length>0){
                // 父级分类的id
                this.addCateForm.cat_pid=this.selectedKeys[this.selectedKeys.length-1]
            }
            this.addCateForm.cat_level=this.
        }
    }
}
</script>
